# Google Cloud Compute Engine VM K3s Project

This project deploys an RKE2 Kubernetes cluster on Google Cloud using Terraform/OpenTofu.
...
- Make sure you are logged into your Google Cloud account from your local Terminal. See the preparatory steps [here](../../../modules/infrastructure/google-cloud/README.md).
