...
| [azurerm_storage_blob.harvester_vhd](https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/resources/storage_blob) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_prefix"></a> [prefix](#input\_prefix) | Specifies the prefix added to the names of all resources. Default is empty. | `string` | `"azure-tf"` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_image_id"></a> [image\_id](#output\_image\_id) | The ID of the custom OS image used for all RKE2 cluster Azure Virtual Machines instances. |
| <a name="output_resource_group"></a> [resource\_group](#output\_resource\_group) | Resource group created on Azure account |
