...
| <a name="input_suse_observability_version"></a> [suse\_observability\_version](#input\_suse\_observability\_version) | Specifies the SUSE Observability Helm chart version to install. Default is 'null' (latest version). | `string` | `null` | no |
