...
| <a name="input_longhorn_version"></a> [longhorn\_version](#input\_longhorn\_version) | Specifies the Longhorn Helm chart version to install. Default is null (latest version). Default is 'null'. | `string` | `null` | no |
